...
set_window_value(AT_JAB, 9, AG_WINDOW_HAS_WHIFFLAG, 4);
...
set_hitbox_value(AT_JAB, 1, HG_HITSTUN_MULTIPLIER, 1.0);
...
set_hitbox_value(AT_JAB, 2, HG_HITSTUN_MULTIPLIER, 1.0);
...
set_hitbox_value(AT_JAB, 3, HG_ANGLE, 32);
