...
set_hitbox_value(AT_FAIR, 1, HG_LIFETIME, 12);
...
set_hitbox_value(AT_FAIR, 2, HG_HITPAUSE_SCALING, 1.5);
set_hitbox_value(AT_FAIR, 2, HG_VISUAL_EFFECT_X_OFFSET, 32);
set_hitbox_value(AT_FAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, -45);
set_hitbox_value(AT_FAIR, 2, HG_VISUAL_EFFECT, 197);
set_hitbox_value(AT_FAIR, 2, HG_HIT_SFX, sound_get("critical-hit-sounds-effect"));
