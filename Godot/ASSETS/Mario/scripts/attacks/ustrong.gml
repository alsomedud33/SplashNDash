...
set_window_value(AT_USTRONG, 1, AG_WINDOW_TYPE, 1); //frame1
set_window_value(AT_USTRONG, 1, AG_WINDOW_LENGTH, 10);
set_window_value(AT_USTRONG, 1, AG_WINDOW_ANIM_FRAMES, 1);

set_window_value(AT_USTRONG, 2, AG_WINDOW_TYPE, 1); //frame2 hitbox1
...
set_window_value(AT_USTRONG, 6, AG_WINDOW_TYPE, 1); //frame7 endlag
...
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_X, 11);
