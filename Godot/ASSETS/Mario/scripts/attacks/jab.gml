...
set_window_value(AT_JAB, 2, AG_WINDOW_ANIM_FRAMES, 1); // hitbox
...
set_window_value(AT_JAB, 5, AG_WINDOW_ANIM_FRAMES, 2); // hitbox
...
set_window_value(AT_JAB, 9, AG_WINDOW_ANIM_FRAME_START, 12); // hitbox
...
set_hitbox_value(AT_JAB, 2, HG_HEIGHT, 27);
