...
sprite_change_offset("walk", 40, 68);
...
sprite_change_offset("dashturn", 34, 62);
...
sprite_change_offset("roll_forward", 32, 56);
sprite_change_offset("roll_backward", 32, 56);
sprite_change_offset("airdodge", 38, 72);
sprite_change_offset("waveland", 32, 62);
sprite_change_offset("tech", 32, 56);
...
sprite_change_offset("nspecial", 32, 62);
sprite_change_offset("fspecial", 64, 94);
sprite_change_offset("uspecial", 64, 94);
sprite_change_offset("dspecial", 32, 62);
...
sprite_change_offset("dspecial_kirby", 32, 52);

set_victory_theme( sound_get( "accurate_fox_victory" ));

sprite_change_offset("feri_costume_wolf", 84, 114);

sprite_change_offset("intro", 184, 278);