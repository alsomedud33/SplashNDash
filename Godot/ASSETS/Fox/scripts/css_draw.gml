if (get_color_profile_slot_r(1, 0) == 255) {
    sound_play(sound_get("fox_camawn"));
    set_color_profile_slot(1, 0, 256, 107, 0);
}
...
textDraw(temp_x + 4, temp_y + 115, "fName", c_white, 0, 1000, 1, true, 1, "v" + patch_ver);
//textDraw(temp_x + 4, temp_y + 115, "fName", c_white, 0, 1000, 1, true, 1, patch_date);
